...
#====================================================================
s.source           = { :git => 'https://github.com/iOS-Risenb/HR_ChainProperty.git', :tag => s.version.to_s }
...
# 3.3:资源文件
#====================================================================
# 'HR_ChainProperty' 为存储的 bundleName
#s.resource_bundles = {
#'HR_ChainProperty' => ['HR_ChainProperty/**/*.{md}']
#}
